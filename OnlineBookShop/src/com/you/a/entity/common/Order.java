...
public class Order {
	...
	public static int ORDER_STATUS_FINISH=2;//已收货
	public static int ORDER_STATUS_CANCEL_WAITNG=3;//用户提交退货请求，等待商家同意中
	public static int ORDER_STATUS_CANCEL_FINISH=4;//用户的退货请求被同意
