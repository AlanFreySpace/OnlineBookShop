...
<body>
	...
	<div class="shop_hd">
		...
		<div class="shop_hd_topNav">
			<div class="shop_hd_topNav_all">
				...
				<div class="shop_hd_topNav_all_left">
					<p>您好，欢迎来到<b><a href="/OnlineBookShop">图书商城</a></b>
		...
		<div class="shop_hd_header">
			<div class="shop_hd_header_logo"><h1 class="logo"><a href="/OnlineBookShop"><img src="../resources/home/images/logo.jpg" alt="ShopCZ" /></a><span>在线图书商城</span></h1></div>
			    ...
			    <div class="search_form">
			    	<form method="post" action="../product/search">
			    		<div class="search_formstyle">
			    			<input type="text" class="search_form_text" name="search_content" value="${search_content }" />
		...
		<div class="shop_hd_menu">
			...
			<ul class="shop_hd_menu_nav">
				<li class="${currentHome }link"><a href="/OnlineBookShop"><span>首页</span></a></li>
