			...
			<div class="form-bd">
				<form action="">
					...
					<dl>
						...
						<img id="login-code" src="../system/get_cpacha?vl=4&w=110&h=30&type=userLoginCpacha" alt="" align="absmiddle" style="position:relative;top:-2px;"/> <a href="javascript:changeCode()" style="color:#999;">看不清，换一张</a></dd>
					</dl>
					<dl>
						<dt>&nbsp;</dt>
...
<script>
	...
	function changeCode(){
		$("#login-code").attr('src','../system/get_cpacha?vl=4&w=110&h=30&type=userLoginCpacha&t='+new Date().getTime());
	}
