...
<body>
	<div class="header wrap1000">
		<a href=""><img src="../resources/home/images/logo.jpg" alt="" /></a>
	</div>
				...
				<form>
					...
					<dl>
						...
						<dd>
							...
							<img id="register-code" src="../system/get_cpacha?vl=4&w=110&h=30&type=userRegisterCpacha" alt="" align="absmiddle" style="position:relative;top:-2px;"/> <a href="javascript:changeCode()" style="color:#999;">看不清，换一张</a></dd>
					</dl>
					<dl>
						<dt>&nbsp;</dt>
	...
	<div class="footer clear wrap1000">
		<p> <a href="/OnlineBookShop">首页</a> | <a href="">招聘英才</a> | <a href="">广告合作</a> | <a href="https://github.com/alan6frey">关于我们</a> | <a href="">联系我们</a></p>
		<p>Copyright 2016-2019 you Inc.,All rights reserved.</p>
	</div>
...
<script>
	...
	function changeCode(){
		$("#register-code").attr('src','../system/get_cpacha?vl=4&w=110&h=30&type=userRegisterCpacha&t='+new Date().getTime());
	}
