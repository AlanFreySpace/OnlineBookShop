...
<body>
	...
	<form action="${pageContext.request.contextPath}/facelogin.action" method="get">
		<dl class="admin_login">
			...
			<dd>
				<input type="button" onclick="query()" value="确认并填写订单" class="submit_btn" />
			</dd>
		...
		<script type="text/javascript">
  		...
  		var con  ={
  			...
  			function query(){
  				...
  				$.ajax({
  					type:"post",
  					url:"${pageContext.request.contextPath}/cart/facelogin.action",
  					data:{"img":imgData1},
  					success:function(data){
  						...
  						/* alert(data) */
							...
							if(data == 'true'){
								 alert("验证成功")
								 window.location.href = '${pageContext.request.contextPath}/cart/list_2'
								} else {
									alert("面容识别失败,请继续验证");
								}
							}
