				...
				<tfoot>
					...
					<tr>
						<td colspan="6" style="text-align:left;">
							<textarea id="order-remark" style="width:1000px;height:36px;" placeholder="请在此处填写订单备注"></textarea>
						</td>
					</tr>
...
<script>
	...
	$(document).ready(function(){
		...
		$("#submit-order-btn").click(function(){
			...
			$.ajax({
				url:'../order/add',
				type:'POST',
				data:{addressId:addressId,remark:$("#order-remark").val(),totalMoney:totalMoney},
				dataType:'json',
				async:false,
				success:function(data){
					if(data.type == 'success'){
	...
	function calTotalMoney(){
		...
		totalMoney=Math.round((totalMoney-"${zhekou}")*10)/10;
