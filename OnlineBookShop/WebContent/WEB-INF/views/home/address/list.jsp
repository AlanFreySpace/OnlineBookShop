				...
				<div class="shop_bd_shdz_lists clearfix">
					<ul>
						...
						<li>
							<label>
								<span>
									<input type="radio" name="shdz" />
								</span>
							</label>
							<em>${address.address }</em><em>${address.name }(收)</em><em>${address.phone }</em>
							<span class="admin_shdz_btn">
								<a href="javascript:void(0)" class="edit-btn" data-name="${address.name }" data-address="${address.address }" data-phone="${address.phone }" data-id="${address.id }">编辑</a>
