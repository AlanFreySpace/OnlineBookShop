...
<style>
	span.pingjia_type{
 	...
 	span.pingjia_type_2{background-position:0 -30px;}
 	span.pingjia_type_3{background-position:0 -60px;}
</style>
					...
					<form athion="" name="" class="shop_form" method="post">
						<ul>
							...
							<li><label>评价类型:</label>
								...
								<span style="float:left;margin-right:16px;">好评</span>
								
								<span class="pingjia_type pingjia_type_2"></span>
								<input style="float:left;margin-top:5px;" type="radio" class="mr5" name="type" value="2" />
								<span style="float:left;margin-right:16px;">中评</span>
								
								<span class="pingjia_type pingjia_type_3"></span>
								<input style="float:left;margin-top:5px;" type="radio" class="mr5" name="type" value="0" />
								<span style="float:left;">差评</span>
							</li>
