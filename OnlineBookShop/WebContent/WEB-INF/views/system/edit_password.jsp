...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:false,iconCls:'icon-save',title:'修改密码',buttons:[{text:'确定',iconCls:'icon-ok',handler:submitEdit}]" style="width:450px; padding:10px;">
