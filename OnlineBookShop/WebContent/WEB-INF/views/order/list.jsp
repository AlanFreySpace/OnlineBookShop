...
<div id="view-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:600px;height:600px;">
     <table id="order-item-datagrid" class="easyui-datagrid" style="width:560px;height:560px;">
     	<thead>
     		<tr>
     			<th field="id">ID</th>
     			<th field="imageUrl" data-options="width:136">图书图片</th>
     			<th field="name" data-options="width:100">图书名称</th>
     			<th field="num" data-options="width:100">图书数量</th>
     			<th field="price" data-options="width:100">图书单价</th>
		...
		$('#view-dialog').dialog({
            ...
            onBeforeOpen:function(){
            	$('#order-item-datagrid').datagrid({
            		...
            		columns:[[
            			{ field:'id',title:'ID'},
            			{ field:'imageUrl',title:'图书图片',width:136,formatter:function(value,index,row){
            				return '<img src='+value+' width="136px">';
            			}},
            			{ field:'name',title:'图书名称',width:136},
            			{ field:'price',title:'图书单价',width:100,sortable:true},
            			{ field:'num',title:'图书数量',width:100,sortable:true},
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'address',title:'收货信息',width:150},
			...
			{ field:'status',title:'订单状态',width:100,formatter:function(value,row,index){
				...
				if(value==3)return '用户请求退货';
				if(value==4)return '同意退货';
				return (value);
			}},
			{ field:'remark',title:'备注',width:200},
			{ field:'createTime',title:'订单创建时间',width:150,formatter:function(value,index,row){
				return format(value);
			}}
		]]
	});
