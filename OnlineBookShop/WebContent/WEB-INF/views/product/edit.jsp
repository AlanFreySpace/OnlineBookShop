...
<div class="easyui-panel" title="编辑图书" style="width:1200px;height:600px;">
...
<form id="edit-form" method="post">
        ...
        <table cellspacing="10">
        	...
        	<tr>
                ...
                <td>
                	<select id="edit-categoryId" name="productCategoryId" idField="id" treeField="name" class="easyui-combotree easyui-validatebox"  data-options="required:true,missingMessage:'请选择图书分类'" url="tree_list" panelHeight="256px" style="width:268px">  
                    </select>
                </td>
            </tr>
        	...
        	<tr>
                ...
                <td><input type="text" name="name" value="${product.name }" class="wu-text easyui-validatebox" data-options="required:true,missingMessage:'请填写图书名称'" /></td>
            </tr>
        
        	<tr>
                <td width="60" align="right">图书图片:</td>
                <td><input readonly="readonly" type="text" value="${product.imageUrl }" id="add-imageUrl" name="imageUrl" class="wu-text easyui-validatebox" data-options="required:true,missingMessage:'请上传图片'" />
        	...
        	<tr>
                ...
                <td><input type="text" name="price" value="${product.price }" class="wu-text easyui-numberbox easyui-validatebox" data-options="required:true,min:0,precision:2,missingMessage:'请填写图书价格'" /></td>
            </tr>
            
            <tr>
                <td width="60" align="right">图书库存:</td>
                <td><input type="text" name="stock" value="${product.stock }" class="wu-text easyui-numberbox easyui-validatebox" data-options="required:true,min:0,precision:0,missingMessage:'请填写图书库存'" /></td>
            </tr>
        
        	<tr>
                <td align="right">图书详情:</td>
                <td style="border:0px;"><textarea id="edit-content" name="content" style="width:650px;height:210px;">${product.content }</textarea></td>     
            </tr>
