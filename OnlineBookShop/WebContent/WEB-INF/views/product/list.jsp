	...
	<form id="add-form" method="post">
        <table>
        	...
        	<tr>
                ...
                <td>
                	<select name="parentId" idField="id" treeField="name" class="easyui-combotree" url="../product_category/tree_list" panelHeight="256px" style="width:268px">
	...
	<form id="edit-form" method="post">
        ...
        <table>
        	...
        	<tr>
                <td width="60" align="right">父分类:</td>
                <td>
                	<select id="edit-parentId" name="parentId" idField="id" treeField="name" class="easyui-combotree" url="../product_category/tree_list" panelHeight="256px" style="width:268px">
